...
public class CouponCustomerServiceImpl implements CouponCustomerService {
    ...
    public Coupon requestCoupon(RequestCoupon request) {
        CouponTemplateInfo templateInfo = templateService.getTemplateInfo(request.getCouponTemplateId());
    ...
    public ShoppingCart placeOrder(ShoppingCart cart) {
        ...
        if (cart.getCouponId() != null) {
            ...
            couponInfo.setTemplate(templateService.getTemplateInfo(coupon.getTemplateId()));
            cart.setCouponInfos(Lists.newArrayList(couponInfo));
        }

        // order 清算
        ShoppingCart checkoutInfo = calculationService.calculateOrderPrice(cart);

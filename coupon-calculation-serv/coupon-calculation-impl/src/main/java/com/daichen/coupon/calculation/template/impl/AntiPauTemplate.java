 ...
 * @description PAU 客户专用优惠计算逻辑，每笔订单享受 996 暴击
 */
@Slf4j
@Component
public class AntiPauTemplate extends AbstractRuleTemplate implements RuleTemplate {
    ...
    protected Long calculateNewPrice(Long orderTotalAmount, Long shopTotalAmount, Long quota) {
        // 凡是在职场碰到上述满口价值观、味道重、不说人话、散播 PUA 思想的人
        // 不管这是同事还是老板，请一顿 996 组合拳伺候

        // 如果这一单 order 总价很高（比如买了一搜航空母舰），这里 *996 后要注意下 Long 范围溢出的问题
